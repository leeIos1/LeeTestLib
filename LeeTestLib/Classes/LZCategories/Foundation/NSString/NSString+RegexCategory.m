...
- (BOOL)isMobileNumberClassification{
    ...
    /**
     ...
     12         */
    NSString * CM = @"^1(34[0-8]|(3[5-9]|4[0-9]|5[017-9]|8[0-9]|7[0-9]|9[0-9])\\d|705)\\d{7}$";
    /**
     15         * 中国联通：China Unicom
     16         * 130,131,132,152,155,156,185,186,1709
     17         */
    NSString * CU = @"^1((3[0-2]|5[256]|8[56]|7[56]|6[6])\\d|709)\\d{7}$";
    /**
...
{
    NSString *filterName = [realName stringByReplacingOccurrencesOfString:@" " withString:@""];
    if (filterName.length <= 0) return NO;
